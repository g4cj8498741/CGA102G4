...
<%--     <jsp:useBean id = "dao" class="com.store.model.StoreService" /> --%>
                ...
                <div class="tab-pane fade" id="drApply" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="row g-3" style="width:700px; margin: 0 auto; margin-top: 50px;">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="date" class="form-control" id="drStartTime"
                                        placeholder="取車時間" >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="drNO" placeholder="調度編號" disabled>
                        <label for="drNO">調度編號</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="drRcarNo" placeholder="調度車號" disabled>
                        <label for="drRcarNo">調度車號</label>
                    </div>
                    <div class="form-floating mb-3" >
                        <input type="text"  id="before" style="display: none;">
    ...
    <script src="<%=request.getContextPath() %>/resources/js/cardispatchrecord/cardispatchrecord.js"></script>
