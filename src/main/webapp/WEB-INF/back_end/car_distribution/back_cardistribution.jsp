...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/car_distribution/car_distribution.css">
...
<%--             <li>${employee.st_no}</li> --%>
    ...
    <script src="<%=request.getContextPath() %>/resources/js/car_distribution/car_distribution.js"></script>
    <script>
