...
<%--     <jsp:useBean id = "dao" class="com.store.model.StoreService" /> --%>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                        type="button" role="tab" aria-controls="home" aria-selected="true">員工資料</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div style="width: 60%; margin: 0 auto; margin-top: 10px;">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="date" class="form-control" id="empBir" placeholder="生日" value="${employee.emp_bir}" disabled>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div style="width: 60%; margin: 0 auto; margin-top: 10px;">
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="password" pattern="[0-9a-fA-F]{6,12}" class="form-control" id="empPass" placeholder="密碼"
                                        value="">
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="password" pattern="[0-9a-fA-F]{6,12}" class="form-control" id="empNewPass" placeholder="密碼"
                                        value="">
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="password" pattern="[0-9a-fA-F]{6,12}" class="form-control" id="empCheckPass" placeholder="密碼"
                                        value="">
    ...
    <script src="<%=request.getContextPath() %>/resources/js/ReviseEmp/empUpdata.js"></script>
