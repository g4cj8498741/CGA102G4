...
<body>
                    ...
                    <thead>
                        ...
                        <c:forEach items="${car}" var="car">
                            <tr>
                                ...
                                <td>
                                    <c:if test="${car.rcar_status == 1 || car.rcar_status == 2 || car.rcar_status == 3 || car.rcar_status == 4}">
    ...
    <script src="<%=request.getContextPath() %>/resources/js/storecarcontrol/storecarcontrol.js"></script>
