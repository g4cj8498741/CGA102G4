        ...
        <div class=" align-items-center logo">
          ...
          <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
            <ul class="site-menu main-menu js-clone-nav ml-auto ">
              ...
              <li><a href="" class="nav-link menuStyle" role="button">聯絡我們</a></li>
...
<%-- 			<jsp:useBean id = "dao" class="com.store.model.StoreService" /> --%>
            <div class="re-form" >
              <div class="row" style="align-items: center; flex-wrap: nowrap;">
                ...
                <div style="width: 150px;">
                  <input type="button" id="send" value="我要租車" class="btn btn-primary btn-block py-3" style="border-radius: 40px;" disabled>
                </div>
              </div>
    	...
    	<div class="col-md-6 col-lg-4 mb-4">
                <div class="listing d-block  align-items-stretch">
                  <div class="listing-img h-100 mr-4">
                    <img src="<%=request.getContextPath()%>/img?model_no=${car.model_no}" alt="Image" class="img-fluid" style="width: 500px; height:250px">
                  </div>
