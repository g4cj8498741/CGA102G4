...
//			if (!vo.getDr_approve_st().equals(st_no)) { // 過濾非本門市車輛
//				iterator.remove();
//			} else if (vo.getDr_approve() == 2 || vo.getDr_approve() == 0) { // 過濾 駁回 或 待同意 的調度
//				iterator.remove();
